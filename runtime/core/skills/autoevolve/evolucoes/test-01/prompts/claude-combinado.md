# Prompt combinado para Claude Code
...
# Prompt Claude Code: Analise: # Especificacao Tecnica: Criar integracao com Google Calenda
...
Skill: integration
Tarefa: TASK-01 - Analise: # Especificacao Tecnica: Criar integracao com Google Calenda
...
# Prompt Claude Code: Planejamento: # Especificacao Tecnica: Criar integracao com Google Calenda
...
Manifesto: runtime/yami-manifest.json
Skill: integration
Tarefa: TASK-02 - Planejamento: # Especificacao Tecnica: Criar integracao com Google Calenda
...
# Prompt Claude Code: Implementacao: # Especificacao Tecnica: Criar integracao com Google Calenda
...
Manifesto: runtime/yami-manifest.json
Skill: integration
Tarefa: TASK-03 - Implementacao: # Especificacao Tecnica: Criar integracao com Google Calenda
...
# Prompt Claude Code: Testes: # Especificacao Tecnica: Criar integracao com Google Calenda
...
# Prompt Claude Code: Validacao: # Especificacao Tecnica: Criar integracao com Google Calenda
...
Manifesto: runtime/yami-manifest.json
Skill: integration
Tarefa: TASK-05 - Validacao: # Especificacao Tecnica: Criar integracao com Google Calenda
...
# Prompt Claude Code: Integracao: # Especificacao Tecnica: Criar integracao com Google Calenda
...
Manifesto: runtime/yami-manifest.json
Skill: integration
Tarefa: TASK-06 - Integracao: # Especificacao Tecnica: Criar integracao com Google Calenda
